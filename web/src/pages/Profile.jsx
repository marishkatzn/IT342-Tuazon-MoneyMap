...
const Profile = () => {
  ...
  return (
    <>
      <Topbar
        title="Profile"
        subtitle="Manage your display name, email, and profile photo"
      />
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '14px' }}>
                {pictureUrl ? (
                  <img
                    src={pictureUrl}
                    alt="Profile"
                    style={{ width: '88px', height: '88px', borderRadius: '24px', objectFit: 'cover', border: '1px solid rgba(255,255,255,.08)', boxShadow: '0 16px 34px rgba(0,0,0,.28)' }}
                  />
                ) : (
                  <div
                    style={{
